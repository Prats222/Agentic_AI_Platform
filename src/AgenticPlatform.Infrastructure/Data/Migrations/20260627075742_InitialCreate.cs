        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelConfigJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentWorkflows", x => new { x.AgentId, x.WorkflowId });
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Workflows_WorkflowId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    InputMappingJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowSteps_Tools_ToolId",
                        column: x => x.ToolId,
                        principalTable: "Tools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1582149a-cb4f-4281-aac8-97f327368835"), "1582149a-cb4f-4281-aac8-97f327368835", "Developer", "DEVELOPER" },
                    { new Guid("2e04c1db-5c39-4e95-a2c2-14b5bfe1e0e1"), "2e04c1db-5c39-4e95-a2c2-14b5bfe1e0e1", "Admin", "ADMIN" },
                    { new Guid("bc879923-4e2a-42e5-934c-cfbbf45898e8"), "bc879923-4e2a-42e5-934c-cfbbf45898e8", "Viewer", "VIEWER" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CreatedAt", "DisplayName", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("2dfbba0f-350f-4e38-a303-b0a58836cc75"), 0, "C7623289-0452-4BA7-A1D3-8C56A2F130BC", new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Platform Administrator", "admin@agenticplatform.local", true, false, null, "ADMIN@AGENTICPLATFORM.LOCAL", "ADMIN@AGENTICPLATFORM.LOCAL", "AQAAAAIAAYagAAAAECtnZbvfijw0FQgbaq9JbAqYfDG5CTQZ95PWx0sBWqYYuz13G6l0ScdpZ5i3eAu7/w==", null, false, "96BA56FA-4F9A-4E8F-A070-40D04FB043DF", false, "admin@agenticplatform.local" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { new Guid("2e04c1db-5c39-4e95-a2c2-14b5bfe1e0e1"), new Guid("2dfbba0f-350f-4e38-a303-b0a58836cc75") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExecutionLogs_ExecutionId_CreatedAt",
                table: "ExecutionLogs",
